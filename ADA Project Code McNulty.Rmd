...
#influence plot - Cook's D plot-identifies observation number in parent dataset; below, observation numbers are identified by row number in the data set as ordered by R; need to look up rowid (case identifier) to find the actual case.
